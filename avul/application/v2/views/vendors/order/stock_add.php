<?php
    $order_id      = !empty($product_value['order_id'])?$product_value['order_id']:'';
    $order_auto_id = !empty($product_value['order_auto_id'])?$product_value['order_auto_id']:'';
    $product_id    = !empty($product_value['product_id'])?$product_value['product_id']:'';
    $product_name  = !empty($product_value['product_name'])?$product_value['product_name']:'';
    $type_id       = !empty($product_value['type_id'])?$product_value['type_id']:'';
    $type_name     = !empty($product_value['type_name'])?$product_value['type_name']:'';
    $unit_val      = !empty($product_value['unit_val'])?$product_value['unit_val']:'';
?>
<style type="text/css">
    .form-actions
    {
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"># <?php echo $order_no; ?></h4>
                            </div>
                                ...
                                <div class="card-body">
                                    <form class="data_form" name="data_form" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="contact_no" class="form-control contact_no" placeholder="Product Name" name="contact_no" value="<?php echo $type_name; ?>" readonly="readonly" style="background-color: #fff;">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <input type="hidden" name="auto_id" id="auto_id" class="auto_id" value="<?php echo $order_auto_id; ?>">
                            ...
                            <div class="card-content collapse show">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a data-id="<?php echo $stock_id; ?>" data-value="vendors" data-cntrl="order" data-func="order_stock" class="delete-btn button_clr btn btn-danger"><i class="ft-trash-2"></i> Delete </a></td>
                                    </tr>
                                <?php
                                                                $i++;
                                                                    }
