        ...
        <div class="content-body">
            <section id="basic-form-layouts">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="contact_no" class="form-control contact_no" placeholder="Contact Number" name="contact_no" value="<?php echo $contact_no; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                ...
                <tr class="row_<?php echo $item_id; ?>">
                    ...
                    <td class="p-l-0">
                        <input type="text" data-te="<?php echo $item_id; ?>" name="product_price[]" id="product_price<?php echo $item_id; ?>" class="form-control product_price<?php echo $item_id; ?> product_price" placeholder="Price" value="<?php echo $product_price; ?>">
                    </td>
                    <td class="p-l-0">
                        <input type="text" data-te="<?php echo $item_id; ?>" name="product_qty[]" id="product_qty<?php echo $item_id; ?>" class="form-control product_qty<?php echo $item_id; ?> product_qty" placeholder="Quantity" value="<?php echo $product_qty; ?>">
                ...
                <tr class="row_1">
                    <td data-te="1" class="p-l-0 product_list" style="width: 40%;">
                        <select data-te="1" name="product_id[]" id="product_id1" class="form-control product_id1 product_id js-select1-multi" data-te="1" style="width: 100%;">
                            <option value="">Select Product Name</option>
                        </select> 
                    </td>
                    <td class="p-l-0">
                        <input type="text" data-te="1" name="product_price[]" id="product_price1" class="form-control product_price1 product_price" placeholder="Price">
                    </td>
                    <td class="p-l-0">
                        <input type="text" data-te="1" name="product_qty[]" id="product_qty1" class="form-control product_qty1 product_qty" placeholder="Quantity">
