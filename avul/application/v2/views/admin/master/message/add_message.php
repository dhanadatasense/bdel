<?php
    $message_id = !empty($dataval[0]['message_id'])?$dataval[0]['message_id']:'0';
    $message    = !empty($dataval[0]['message'])?$dataval[0]['message']:'';
                                ...
                                <div class="card-body">
                                    <form class="data_form" name="data_form" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Message <span class="text-danger">*</span></label>
                                                        <textarea type="text" id="message" class="form-control message" placeholder="Message" name="message"><?php echo $message; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <input type="hidden" name="message_id" id="message_id" class="message_id" value="<?php echo $message_id; ?>">
                                            ...
                                            <input type="hidden" name="func" id="func" class="func" value="add_message">
