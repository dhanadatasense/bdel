<?php
    $city_id     = !empty($dataval[0]['city_id'])?$dataval[0]['city_id']:'0';
    $state_value = !empty($dataval[0]['state_id'])?$dataval[0]['state_id']:'0';
    $city_name   = !empty($dataval[0]['city_name'])?$dataval[0]['city_name']:'';
    $city_code   = !empty($dataval[0]['city_code'])?$dataval[0]['city_code']:'';
                                ...
                                <div class="card-body">
                                    <form class="data_form" name="data_form" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="city_name" class="form-control city_name" placeholder="City Name" name="city_name" value="<?php echo $city_name; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput1">City Code <span class="text-danger">*</span></label>
                                                        <input type="text" id="city_code" class="form-control city_code" placeholder="City Code" name="city_code" value="<?php echo $city_code; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <input type="hidden" name="city_id" id="city_id" class="city_id" value="<?php echo $city_id; ?>">
                                            ...
                                            <input type="hidden" name="func" id="func" class="func" value="add_city">
