<?php
    $variation_id   = !empty($dataval[0]['variation_id'])?$dataval[0]['variation_id']:'0';
    $variation_name = !empty($dataval[0]['variation_name'])?$dataval[0]['variation_name']:'';
                                ...
                                <div class="card-body">
                                    <form class="data_form" name="data_form" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Variation Name <span class="text-danger">*</span></label>
                                                        <input type="text" id="variation_name" class="form-control variation_name" placeholder="Variation Name" name="variation_name" value="<?php echo $variation_name; ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <input type="hidden" name="func" id="func" class="func" value="add_variations">
