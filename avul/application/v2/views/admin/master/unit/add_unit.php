<?php
    $unit_id   = !empty($dataval[0]['unit_id'])?$dataval[0]['unit_id']:'0';
    $unit_name = !empty($dataval[0]['unit_name'])?$dataval[0]['unit_name']:'';
                                ...
                                <div class="card-body">
                                    <form class="data_form" name="data_form" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="unit_name" class="form-control unit_name" placeholder="Unit Name" name="unit_name" value="<?php echo $unit_name; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <input type="hidden" name="unit_id" id="unit_id" class="unit_id" value="<?php echo $unit_id; ?>">
                                            ...
                                            <input type="hidden" name="func" id="func" class="func" value="add_unit">
