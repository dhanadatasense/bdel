<?php
    $state_id   = !empty($dataval[0]['state_id'])?$dataval[0]['state_id']:'0';
    $state_name = !empty($dataval[0]['state_name'])?$dataval[0]['state_name']:'';
    $state_code = !empty($dataval[0]['state_code'])?$dataval[0]['state_code']:'';
    $gst_code   = !empty($dataval[0]['gst_code'])?$dataval[0]['gst_code']:'';
                                ...
                                <div class="card-body">
                                    <form class="data_form" name="data_form" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="state_name" class="form-control state_name" placeholder="State Name" name="state_name" value="<?php echo $state_name; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Short Code <span class="text-danger">*</span></label>
                                                        <input type="text" id="state_code" class="form-control state_code" placeholder="Short Code" name="state_code" value="<?php echo $state_code; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput1">State Code <span class="text-danger">*</span></label>
                                                        <input type="text" id="gst_code" class="form-control gst_code" placeholder="State Code" name="gst_code" value="<?php echo $gst_code; ?>" maxlength="2" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <input type="hidden" name="state_id" id="state_id" class="state_id" value="<?php echo $state_id; ?>">
                                            ...
                                            <input type="hidden" name="func" id="func" class="func" value="add_state">
