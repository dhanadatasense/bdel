<style type="text/css">
    ...
    .select_list .select2-container--default
    {
        width: 100% !important;
    }
                                ...
                                <div class="card-body card-dashboard pt-0">
                                    <form class="data_form" name="data_form" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="amount" class="form-control amount int_value" placeholder="Amount" name="amount" value="<?php echo $amount; ?>" <?php echo $read_only; ?> style="background-color: #fff;">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Discount</label>
                                                        <input type="text" id="discount" class="form-control discount int_value" placeholder="Discount" name="discount" value="<?php echo $discount; ?>" <?php echo $read_only; ?> style="background-color: #fff;">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Entry Date <span class="text-danger">*</span></label>
                                                        <input type="text" id="entry_date" class="form-control entry_date dates" placeholder="Entry Date" name="entry_date" value="<?php echo $entry_date; ?>" <?php echo $read_only; ?> style="background-color: #fff;">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control amt_type js-select1-multi" id="amt_type" name="amt_type">
                                                            ...
                                                            <option value="4" <?php echo $amt_type == 4 ? 'selected' : ''; ?>>Purchase Return</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="bank_name" class="form-control bank_name" placeholder="Bank Name" name="bank_name" value="<?php echo $bank_name; ?>" <?php echo $read_only; ?> style="background-color: #fff;">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Cheque No <span class="text-danger">*</span></label>
                                                            <input type="text" id="cheque_no" class="form-control cheque_no" placeholder="Cheque No" name="cheque_no" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" value="<?php echo $cheque_no; ?>" <?php echo $read_only; ?> style="background-color: #fff;">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Collection Date <span class="text-danger">*</span></label>
                                                            <input type="text" id="collect_date" class="form-control collect_date atdates" placeholder="Collection Date" name="collect_date" value="<?php echo $collect_date; ?>" <?php echo $read_only; ?> style="background-color: #fff;">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-actions">
                                            <input type="hidden" name="po_id" id="po_id" class="po_id" value="">
                                            <input type="hidden" name="po_no" id="po_no" class="po_no" value="">

                                            <button type="button" class="btn btn-primary vendor_payment" data-type="_s_c" data-value="admin" data-cntrl="payment" data-func="vendor_payment" data-method="<?php echo $method; ?>" data-id="<?php echo $random_val; ?>" data-auto="<?php echo $auto_id; ?>">
                                        ...
                                        <div class="col-sm-12 filter-design">
                                            <div class="form-group row">
                                                <div class="col-sm-2 text-right">
                                                    ...
                                                    <input type="hidden" name="func" id="func" class="func" value="vendor_payment">
