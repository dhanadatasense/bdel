<?php
    $category_value   = !empty($dataval[0]['category_id'])?$dataval[0]['category_id']:'0';
    $sub_category_id   = !empty($dataval[0]['id'])?$dataval[0]['id']:'';
    $sub_category_name = !empty($dataval[0]['category_name'])?$dataval[0]['category_name']:'';
    $sub_status        = !empty($dataval[0]['status'])?$dataval[0]['status']:'0';
                                ...
                                <div class="card-body">
                                    <form class="data_form" name="data_form" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="sub_category_name" class="form-control sub_category_name" placeholder="Category Name" name="sub_category_name" value="<?php echo $sub_category_name; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="postType1" name="pstatus" class="custom-control-input" <?php echo $sub_status==1 ? 'checked' : ''; ?> value="1">
                                                                    <label class="custom-control-label" for="postType1">Active</label>
                                                                </div>
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="postType2" name="pstatus" class="custom-control-input" <?php echo $sub_status==0 ? 'checked' : ''; ?> value="0">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <input type="hidden" name="sub_category_id" id="sub_category_id" class="sub_category_id" value="<?php echo $sub_category_id; ?>">
                                            ...
                                            <input type="hidden" name="func" id="func" class="func" value="add_sub_category">
