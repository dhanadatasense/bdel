                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control mis_year_id year_id js-select1-multi" id="year_id" name="year_id" style="width: 100%;">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Select Employee Name <span class="text-danger">*</span></label>
                                                        <select class="form-control mis_employee_id employee_id js-select1-multi" id="employee_id" name="employee_id" style="width: 100%;">
                        ...
                        echo '<option value="'.$employee_id.'">'.$username.' - '.$mobile.'</option>';
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="emp_name" id="emp_name" class="emp_name" value="">

                                                        <button type="button" class="btn btn-primary rpt_submit misReport_submit m-t-27" data-month="" data-type="_s_c" data-value="admin" data-cntrl="misreport" data-func="employee_wise_order_view">
