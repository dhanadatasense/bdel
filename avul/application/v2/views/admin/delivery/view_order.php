    ...
    <div class="content-wrapper">
        <div class="content-body">
            <?php
                ...
                {
                    ?>
                        <?php if(userAccess('distributors-order-edit')): ?>
                        <div class="row">
                            <?php
                                if(!empty($reason))
                                {
                                        ...
                                        <input type="text" id="weight" class="form-control weight" placeholder="Weight (.kg)" name="length" value="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                                                ...
                                                                <div class="col-md-12 m-t-10">
                                                                    <div class="form-group text-right">
                                                                        ...
                                                                        <input type="hidden" name="dc_id" id="dc_id" class="dc_id" value="<?php echo $dc_id; ?>">
                                                                        <input type="hidden" name="value" id="value" class="value" value="admin">
                                                                        <input type="hidden" name="cntrl" id="cntrl" class="cntrl" value="deliverychallan">
                                                                        <input type="hidden" name="func" id="func" class="func" value="order_process">
                                                                        <button type="button" class="btn btn-success delivery_button process_submit" style="background-color: #28d094 !important; color: #fff;"> 
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="font-12" style="width: 13%;">
                                        <?php if(userAccess('distributors-order-edit') == TRUE): ?>
                                            <a data-id="<?php echo $auto_id; ?>" class="order_update button_clr btn btn-primary" data-value="admin" data-cntrl="deliverychallan" data-func="order_process" style="background-color: #666ee8 !important;"><i class="ft-edit"></i></a>
                                        <?php endif; ?>
                                        <?php if(userAccess('distributors-order-delete') == TRUE): ?>
                                            <a data-id="<?php echo $auto_id; ?>" data-progress="<?php echo $order_status; ?>" data-value="admin" data-cntrl="deliverychallan" data-func="order_process" class="delete-order button_clr btn btn-danger" style="background-color: #ff4961 !important;"><i class="ft-trash-2"></i></a>
                                        <?php endif; ?>
                                        </td>
                                    <?php endif; ?>
                                </tr>
                ...
                <tbody>
                    <?php
                        ...
                        foreach ($order_details as $key => $value) {
                            ...
                            {
                                $stk_link = BASE_URL.'index.php/admin/deliverychallan/order_stock/stock_add/'.$auto_id.'/'.$order_id;
                            }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            {
                                                ?>
                                                    <button class="btn btn-warning pack_btn" data-id="<?php echo $auto_id; ?>" data-value="admin" data-cntrl="deliverychallan" data-func="order_process" data-method="_changePackStatus" style="padding: 4px;"><i class="ft-rotate-cw"></i> </button>

                                                    <button class="btn btn-danger del_bth" data-id="<?php echo $auto_id; ?>" data-value="admin" data-cntrl="deliverychallan" data-func="order_process" data-method="_deletePackStatus" style="padding: 4px;"><i class="ft-trash-2"></i> </button>
                                                <?php
                                            }
                                        ?>
                                    </td>
                    ...
                    <tr>
                        ...
                        <td><?php echo number_format((float)$net_value, 2, '.', ''); ?></td>
                                    ...
                                    <?php
                                        if($order_status == 2)
                                        {
                                            $print_link = BASE_URL.'index.php/admin/deliverychallan/print_order/'.$order_id;
                                        ...
                                        else if($order_status == 3)
                                        {
                                            ?>
                                                <div id="invoice-footer">
                                                    <div class="row">
                                                        <div class="col-sm-12 col-12 text-right">
                                                            <button class="btn btn-info btn-lg my-1 process_click" data-value="admin" data-cntrl="deliverychallan" data-func="order_process" data-method="_changePackProcess" data-id="<?php echo $order_id; ?>"><i class="fa fa-spinner"></i> Approved Order</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php
                                        ...
                                        else if($order_status == 4 || $order_status == 5 || $order_status == 10 || $order_status == 11)
                                        {
                                            if(!empty($inv_random))
                                            {
                                                $print_link = BASE_URL.'index.php/admin/deliverychallan/print_invoice/'.$inv_random;

                                                $print_json = BASE_URL.'index.php/admin/deliverychallan/print_json/'.$inv_random;
