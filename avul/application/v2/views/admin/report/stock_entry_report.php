...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('stock-entry-report-view') == TRUE): ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit stockEntry_report stock_submit m-t-27" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="stock_entry_report">
        ...
        <?php if(userAccess('stock-entry-report-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
