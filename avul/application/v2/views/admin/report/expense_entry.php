...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('expense-report-view') == TRUE): ?>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="data_form" name="data_form" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit expense_report expense_submit m-t-27" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="expense_report">
                                                        ...
                                                        <!-- <span class="expense_export"></span> -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 filter-design">
                                                <div id="expense_error" class="alert alert-danger text-center">
                                                    <b>No items found...</b>
                                                </div>
                                            </div>
                                        </div>
        ...
        <?php if(userAccess('expense-report-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
