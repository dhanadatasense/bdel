...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('overall-order-report-view') == TRUE): ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit order_report order_submit m-t-27" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="order_report">
        ...
        <?php if(userAccess('overall-order-report-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
