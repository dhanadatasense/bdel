<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('product-stock-view') == TRUE): ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group"> 
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit productStock_report productStock_submit m-t-27" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="product_stock">
        ...
        <?php if(userAccess('product-stock-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
