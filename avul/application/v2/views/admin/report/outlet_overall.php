<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('outlet-overall-report-view') == TRUE): ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit outletOverall_report outletOverall_submit" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="outlet_overall">
        ...
        <?php if(userAccess('outlet-overall-report-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
