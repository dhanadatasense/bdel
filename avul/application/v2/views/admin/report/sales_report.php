...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('distributor-sales-report-view') == TRUE): ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit sales_report rpt_submit sales_submit" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="sales_report">
        ...
        <?php if(userAccess('distributor-sales-report-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
