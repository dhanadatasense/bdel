<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('beat-wise-outlet-report-view') == TRUE): ?>
                                    ...
                                    <form class="data_form" name="data_form" method="post">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Beat Type</label>

                                                        <select class="form-control status_val js-select1-multi" id="status_val" name="status_val">
                                                            <option value="">Select Beat Name</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="func" id="func" class="func" value="beat_outlet">

                                                        <button type="button" class="btn btn-primary rpt_submit beatOutlet_report beatOutlet_submit" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="beat_outlet">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 filter-design">
                                                <div class="beatOutlet_value hide">
        ...
        <?php if(userAccess('beat-wise-outlet-report-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
