...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('target-achievement-view') == TRUE): ?>
                                    ...
                                    <form class="data_form" name="data_form" method="post">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="projectinput1">View Type <span class="text-danger">*</span></label>
                                                        <select class="form-control view_type js-select1-multi" id="view_type" name="view_type" style="width: 100%;">
                                                            <option value="">Select Vendor Name</option>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="func" id="func" class="func" value="target_achievement">
                                                        <button type="button" class="btn btn-primary rpt_submit target_report target_submit m-t-27" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="target_achievement">
        ...
        <?php if(userAccess('target-achievement-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
