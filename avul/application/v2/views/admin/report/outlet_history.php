<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('outlet-history-view') == TRUE): ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit outletHistory_report outletHistory_submit" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="outlet_history" style="margin-top: 8%;">
        ...
        <?php if(userAccess('outlet-history-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
