...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('sales-return-report-view') == TRUE): ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit sales_report rpt_submit sales_submit m-t-27" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="sales_return">
        ...
        <?php if(userAccess('sales-return-report-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
