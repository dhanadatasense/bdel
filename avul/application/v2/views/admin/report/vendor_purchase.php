<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('vendor-purchas-report-view') == TRUE): ?>
                                    ...
                                    <form class="data_form" name="data_form" method="post">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Select Vendor Name</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Select Product Name</label>
                                                        <select data-te="1" name="product_id[]" id="product_id" class="form-control product_id1 product_id js-select1-multi" data-te="1">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Select Product Type</label>
                                                        <select data-te="1" name="type_id[]" id="type_id" class="form-control type_id1 type_id js-select1-multi" data-te="1">
                                                            <option value="">Select Product Name</option>
                                                        </select> 
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="func" id="func" class="func" value="vendor_purchase">

                                                        <button type="button" class="btn btn-primary rpt_submit vendor_purchase vendorPurchase_submit m-t-27" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="vendor_purchase">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 filter-design">
                                                <div class="vendorPurchase_value hide">
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tbody id="getVendorPurchaseList">
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                </div>
        ...
        <?php if(userAccess('vendor-purchas-report-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
