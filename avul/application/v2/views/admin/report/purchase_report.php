<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('purchas-report-view') == TRUE): ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="func" id="func" class="func" value="purchase_report">

                                                        <button type="button" class="btn btn-primary rpt_submit vendorOverall_report vendorOverall_submit m-t-27" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="purchase_report">
        ...
        <?php if(userAccess('purchas-report-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
