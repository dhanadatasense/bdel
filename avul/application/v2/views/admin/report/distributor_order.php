<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('distributor-order-report-view') == TRUE): ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit distributorOrder_report distributorOrder_submit m-t-27" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="distributor_order">
                                                        ...
                                                        <span class="hoisst_val"></span>
                                                        <!-- <span class="del_val"></span> -->
        ...
        <?php if(userAccess('distributor-order-report-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
