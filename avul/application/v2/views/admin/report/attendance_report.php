                        ...
                        echo '<option value="'.$employee_id.'">'.$username.' ('.$mobile.')'.'</option>';
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit attendance_report attendance_submit m-t-27" data-type="_s_c" data-value="admin" data-cntrl="report" data-func="attendance_report">
