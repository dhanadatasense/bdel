<?php 
   ...
   $approvel='1';
    $edit_link = BASE_URL . 'index.php/admin/distributors/add_distributors/Edit/' .$distributor_id.'/'.$approvel;
            ...
            <div class="content-header-right col-md-6 col-12">
                ...
                <?php if ($status == 3) : ?>
                 <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                    ...
                    <button type="button" class="btn btn-info round px-2 mb-1 delete-btn" data-type="_s_c" data-id="<?php echo $distributor_id ?>" data-value="admin" data-cntrl="Distributors" data-func="list_dis_approval">
                ...
                <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
                <!-- href="'.BASE_URL.'index.php/admin/distributors/add_distributors/Edit/'.$distributor_id.'" -->
<!--                    
                    <button type="button" class="btn btn-success round px-2 mb-1 approve-btn" data-type="_s_c" data-id="<?php echo $distributor_id ?>" data-value="admin" data-cntrl="Distributors" data-func="add_distributors">
                        ...
                        <!-- Button with the link -->
                        <a href="<?php echo $edit_link; ?>" class="btn btn-success round px-2 mb-1 approve-btn">
                        Approval
                        </a>
                </div>
                <?php endif; ?>
