<?php
    ...
    $distributor_details   = !empty($dataval['distributor_details'])?$dataval['distributor_details']:'';
    ...
    $distributor_res  = !empty($bill_details['distributor_id'])?$bill_details['distributor_id']:'';
    ...
    // distributor Details
    $company_name = !empty($distributor_details['company_name'])?$distributor_details['company_name']:'';
    $gst_no       = !empty($distributor_details['gst_no'])?$distributor_details['gst_no']:'';
    $mobile   = !empty($distributor_details['mobile'])?$distributor_details['mobile']:'';
    $email        = !empty($distributor_details['email'])?$distributor_details['email']:'';
    $address      = !empty($distributor_details['address'])?$distributor_details['address']:'';
                                            ...
                                            <div class="row">
                                                        ...
                                                        <select class="form-control distributor_id js-select1-multi" id="distributor_id" name="distributor_id" style="width: 100%;">
                                                            ...
                                                            <?php
                                                                if(!empty($distributor_val))
                                                                {
                                                                    ...
                                                                    echo "<option value=".$distributor_id." ".$selected.">".$company_name."</option>";
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="contact_no" class="form-control mobile int_value" placeholder="Contact Number" name="mobile" value="<?php echo $mobile; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <table id="item_table" class="table">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="p-l-0">
                                                                        <button type="button" name="remove" class="btn btn-success btn-sm add_purchase_distributors button_size m-t-6"><span class="ft-plus-square"></span></button>
                                                                    </th>
                                                                </tr>
                                                            </thead>
                    ...
                    <td class="buttonlist p-l-0">
                        <button type="button" name="remove" class="btn btn-danger btn-sm  button_size m-t-6"><span class="ft-minus-square"></span></button>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <input type="hidden" name="func" id="func" class="func" value="distributor_orders_entry">
