...
$admin_data      = !empty($purchase_data['admin_details']) ? $purchase_data['admin_details'] : '';
...
$dc_id     = !empty($bill_details['dc_id']) ? $bill_details['dc_id'] : '';
$dc_no     = !empty($bill_details['dc_no']) ? $bill_details['dc_no'] : '';
$dc_random     = !empty($bill_details['dc_random']) ? $bill_details['dc_random'] : '';
...
$delivered_date = '---';
if (!empty($_delivery)) {
    $delivered_date = date('d-M-Y h:i:s A', strtotime($_delivery));
}
...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        <div class="content-body">
            ...
            ?>
                    <?php if (userAccess('delivery-challan-edit')) : ?>
                        <div class="row">
                            <?php
                            if (!empty($reason)) {
                                if ($order_status == 7) {
                                            ...
                                            <div class="card-content">
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 delivery_address m-t-10 hide">
                                                            <div class="row clearfix form-group">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                   <label for="projectinput1">Address</label>
                                                                   <textarea id="dly_address" class="form-control dly_address" placeholder="Delivery Address" name="dly_address" rows="3"></textarea>
                                                                </div>
                                                            </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12 m-t-10">
                                                            <div class="form-group text-right">
                                                                ...
                                                                <input type="hidden" name="invoice_id" id="invoice_id" class="invoice_id" value="<?php echo $dc_id; ?>">
                                                                <input type="hidden" name="value" id="value" class="value" value="admin">
                                                                <input type="hidden" name="cntrl" id="cntrl" class="cntrl" value="Distributorordertwo">
                        ...
                        <section class="card" style="width: 100%;">
                            <div id="invoice-template" class="card-body p-4">
                                    ...
                                    <div class="col-sm-6 col-12 text-center text-sm-left">
                                        <div class="media row">
                                            <div class="col-12 col-sm-6 col-xl-6">
                                                <img class="brand-logo" alt="modern admin logo" src="<?php echo BASE_URL; ?>app-assets/images/logo/logobdel.jpg">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="invoice-customer-details" class="row pt-2">
                                    ...
                                    <?php
                                        if ($order_status == '11') {
                                            ...
                                            <div class="col-sm-3 col-12 text-center">
                                            <ul class="px-0 list-unstyled">
                                                <li><b>Delivered Date</b></li>
                                                <li><?php echo $delivered_date; ?></li>
                                            </ul>
                                            </div> 
                                        <?php
                                        }else{
                                                    ...
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <?php if (userAccess('delivery-challan-edit') == TRUE || userAccess('delivery-challan-delete') == TRUE) : ?>
                                                        ...
                                                        <tbody id="myTable">
                                                            ...
                                                            foreach ($order_details as $key => $value) {
                                                                ...
                                                                $product_name     = !empty($value['description']) ? $value['description'] : '';
                                                            ...
                                                            ?>
                                                                <tr class="row_<?php echo $i; ?>">
                                                                    ...
                                                                    <td class="font-12"><?php echo mb_strimwidth($product_name, 0, 60, '...'); ?></td>
                                                                    ...
                                                                    <td class="font-12">
                                                                        ...
                                                                        <input data-val="<?php echo $auto_id; ?>" type="text" id="qty" class="form-control qty qty_<?php echo $auto_id; ?> int_value"  oninput="this.value=this.value.replace(/^0+/g,'')"   maxlength="5" placeholder="" name="qty" value="<?php echo $product_qty; ?>" style="height: calc(1em + 1.0rem + 0px); padding: 5px;">
                                                                    </td>
                                                                    ...
                                                                    <?php if (userAccess('delivery-challan-edit') == TRUE || userAccess('delivery-challan-delete') == TRUE) : ?>
                                                                        <td class="font-12" style="width: 13%;">
                                                                            ...
                                                                            <?php if (userAccess('delivery-challan-edit') == TRUE) : ?>
                                                                                <a data-id="<?php echo $auto_id; ?>" class="order_update button_clr btn btn-primary" data-value="admin" data-cntrl="distributorordertwo" data-func="order_process" style="background-color: #666ee8 !important;"><i class="ft-edit"></i></a>
                                                                            <?php endif; ?>
                                                                            <?php if (userAccess('delivery-challan-delete') == TRUE) : ?>
                                                                                <a data-id="<?php echo $auto_id; ?>" data-progress="<?php echo $order_status; ?>" data-value="admin" data-cntrl="distributorordertwo" data-func="order_process" class="delete-order button_clr btn btn-danger" style="background-color: #ff4961 !important;"><i class="ft-trash-2"></i></a>
                                                                            <?php endif; ?>
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tfoot>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><b><?php echo number_format((float)$net_value, 2, '.', ''); ?></b></td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
                                                </div>
                                                        ...
                                                        <tbody  id="myTable">
                                                            ...
                                                            foreach ($order_details as $key => $value) {
                                                                ...
                                                                if ($product_qty == $receive_qty) {
                                                                    ...
                                                                    $stk_link = BASE_URL . 'index.php/admin/distributorsorder/order_stock/stock_add/' . $auto_id . '/' . $order_id;
                                                                }

                                                            ?>
                                                                <tr>
                                                                    <td><?php echo $i; ?></td>
                                                                    <td style="font-size: 13px;"><?php echo $product_name; ?></td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        ?>
                                                                            <button class="btn btn-warning pack_btn" data-id="<?php echo $auto_id; ?>" data-value="admin" data-cntrl="Distributorordertwo" data-func="order_process" data-method="_changePackStatus" style="padding: 4px;"><i class="ft-rotate-cw"></i> </button>

                                                                            <button class="btn btn-danger del_bth" data-id="<?php echo $auto_id; ?>" data-row="<?php echo $i; ?>" data-value="admin" data-cntrl="Distributorordertwo" data-func="order_process" data-method="_deletePackStatus" style="padding: 4px;"><i class="ft-trash-2"></i> </button>
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($order_details as $key => $val) {
                                                                $product_name = !empty($val['description']) ? $val['description'] : '';
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo number_format((float)$pdt_price, 2, '.', ''); ?></td>
                                                                    <td>nos</td>
                                ...
                                if ($order_status == 2 || $order_status == 1) {
                                    $print_link = BASE_URL . 'index.php/admin/distributorordertwo/print_order/' . $order_id;
                                ...
                                ?>
                                    <div id="invoice-footer">
                                        <div class="row">
                                            <div class="col-sm-12 col-12 text-right">
                                                <button class="btn btn-info btn-lg my-1 process_click" data-value="admin" data-cntrl="distributorordertwo" data-func="order_process" data-method="_changePackProcess" data-id="<?php echo $order_id; ?>"><i class="fa fa-spinner"></i> Approved Order</button>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    if (!empty($dc_random)) {
                                        $print_link = BASE_URL . 'index.php/admin/distributorordertwo/print_dc/' . $dc_random;

                                        $print_json = BASE_URL . 'index.php/admin/distributorordertwo/print_json/' . $dc_random;

                                    ?>
                                        <div id="invoice-footer">
                                            <div class="row">
                                                <div class="col-sm-12 col-12 text-right">
                                                    <a target="_blank" href="<?php echo $print_link; ?>" class="btn btn-info btn-lg my-1"><i class="fa fa-print"></i> Print DC</a>
