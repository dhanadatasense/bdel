                            ...
                            <div class="col-md-12 delivery_message m-t-10 hide">
                                ...
                                <div class="row clearfix form-group">
                                    ...
                                    <div class="col-md-3 eway_value hide">
                                        <label for="firstName2">Transporter GSTIN <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-3 eway_value hide">
                                        <label for="firstName2">Transporter Name <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-3 eway_value hide">
                                        <div class="form-group" style="display: grid;">
                                            <label for="projectinput1">Transportation Mode <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-3 eway_value hide">
                                        <label for="firstName2">Vehicle No <span class="text-danger">*</span></label>
                                        <input type="text" id="vehicle_number" class="form-control vehicle_number" placeholder="Vehicle No" name="vehicle_number" value="">
                                    </div>
                                    <div class="col-md-3 eway_value hide">
                                        <div class="form-group" style="display: grid;">
                                            <label for="projectinput1">Vehicle Type <span class="text-danger">*</span></label>
                                            ...
                                            <input type="hidden" id="transporter_document_date" class="form-control transporter_document_date atdates" placeholder="Document Date" name="transporter_document_date" value="">
                                                                ...
                                                                <div class="col-md-12 m-t-10">
                                                                    <div class="form-group text-right">
                                                                        ...
                                                                        <input type="hidden" name="inv_random" id="inv_random" class="inv_random" value="<?php echo $inv_random; ?>">
                                ...
                                <tr class="row_<?php echo $i; ?>">
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            {
                                                ?>
                                                    <button class="btn btn-warning pack_btn" data-id="<?php echo $auto_id; ?>" data-value="admin" data-cntrl="distributorsorder" data-func="order_process" data-method="_changePackStatus" style="padding: 4px;"><i class="ft-rotate-cw"></i> </button>

                                                    <button class="btn btn-danger del_bth" data-id="<?php echo $auto_id; ?>" data-row="<?php echo $i; ?>" data-value="admin" data-cntrl="distributorsorder" data-func="order_process" data-method="_deletePackStatus" style="padding: 4px;"><i class="ft-trash-2"></i> </button>
                                                <?php
                                            }
                                        ?>
                                    </td>
                    ...
                    <tr>
                        ...
                        <td><?php echo number_format((float)$net_value, 2, '.', ''); ?></td>
                                    ...
                                    <?php
                                        if($order_status == 2)
                                        {
                                            $print_link = BASE_URL.'index.php/admin/distributorsorder/print_order/'.$po_id;
                                        ...
                                        else if($order_status == 3)
                                        {
                                            ?>
                                                <div id="invoice-footer">
                                                    <div class="row">
                                                        <div class="col-sm-12 col-12 text-right">
                                                            <button class="btn btn-info btn-lg my-1 process_click" data-value="admin" data-cntrl="distributorsorder" data-func="order_process" data-method="_changePackProcess" data-id="<?php echo $po_id; ?>"><i class="fa fa-spinner"></i> Approved Order</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php
                                        ...
                                        else if($order_status == 4 || $order_status == 5 || $order_status == 10 || $order_status == 11)
                                        {
                                            if(!empty($inv_random))
                                            {
                                                $print_link = BASE_URL.'index.php/admin/distributorsorder/print_invoice/'.$inv_random;

                                                $print_json = BASE_URL.'index.php/admin/distributorsorder/print_json/'.$inv_random;
