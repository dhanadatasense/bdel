...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <?php if(userAccess('bank-entry-view') == TRUE): ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit account_report account_submit m-t-27" data-type="_s_c" data-value="admin" data-cntrl="accounts" data-func="bank_entry">
        ...
        <?php if(userAccess('bank-entry-view') == FALSE): ?>
        <div class="row">
            <div class="col-sm-12 filter-design">
