<?php
    ...
    $sub_id   = !empty($target_data['sub_cat_id'])?$target_data['sub_cat_id']:'';
                                    ...
                                    <form class="data_form" name="data_form" method="post">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <button type="button" class="btn btn-primary product_list product_submit m-t-27 <?php echo $hide_value; ?>" data-type="_s_c" data-value="admin" data-cntrl="target" data-func="add_product_target">
        ...
        foreach ($target_list as $key => $value) {
            ...
            $num++;
                                        ...
                                        <div class="form-actions submit_btn <?php echo $view_value; ?>">
                                            ...
                                            <input type="hidden" name="func" id="func" class="func" value="add_product_target">
