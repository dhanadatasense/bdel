                                    ...
                                    <form class="data_form" name="data_form" method="post">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <button type="button" class="btn btn-primary beat_list beat_submit m-t-27 <?php echo $hide_value; ?>" data-type="_s_c" data-value="admin" data-cntrl="target" data-func="add_beat_target">
        ...
        foreach ($target_list as $key => $value) {
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" data-te="<?php echo $num; ?>" name="zone_id[]" id="zone_id<?php echo $num; ?>" class="form-control zone_id<?php echo $num; ?> zone_id" placeholder="Target Value" value="<?php echo $zone_id; ?>">
            ...
            $num++;
                                        ...
                                        <div class="form-actions submit_btn <?php echo $view_value; ?>">
                                            ...
                                            <input type="hidden" name="func" id="func" class="func" value="add_beat_target">
