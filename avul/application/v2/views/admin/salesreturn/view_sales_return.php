<?php
    ...
    $print_link = BASE_URL.'index.php/admin/salesreturn/list_sales_return/print_invoice/'.$return_value;
?>
...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        <div class="content-body">
        	<?php if(userAccess('sales-return-view') == TRUE) : ?>
        	<div class="row">
            ...
            <?php endif; ?>
            <?php if(userAccess('sales-return-view') == FALSE) : ?>
