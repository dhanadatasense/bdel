        ...
        <script src="<?php echo BASE_URL; ?>assets/ajax/ajax-dashboard.js"></script>
        ...
        <script src="<?php echo BASE_URL; ?>app-assets/js/scripts/pages/dashboard-crypto.min.js"></script>

        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAHQCGm6t8IgZ77_cJTbezg-wII-eboBtc&amp;libraries=places"></script>

        <script src="//maps.googleapis.com/maps/api/js?key=AIzaSyAHQCGm6t8IgZ77_cJTbezg-wII-eboBtc&amp;libraries=places"></script>
