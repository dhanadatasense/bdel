                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group text-right">
                                                                            ...
                                                                            <input type="hidden" name="func" id="func" class="func" value="view_purchase_return">
                                    ...
                                    <div id="invoice-customer-details" class="row pt-2">
                                        ...
                                        <div class="col-sm-6 col-12 text-center text-sm-right">
                                            <ul class="px-0 list-unstyled">
                                                <li class="text-bold-800"><b><?php echo $usr_vendor_name; ?></b></li>
            ...
            <?php
                    ...
                    <tr>
                        ...
                        <td><?php echo number_format((float)$net_value, 2, '.', ''); ?></td>
                                    ...
                                    <?php
                                        $print_link = BASE_URL.'index.php/admin/purchase/print_return/'.$usr_order_id;
