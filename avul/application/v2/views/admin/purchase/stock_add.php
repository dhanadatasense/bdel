<?php
    ...
    $type_id      = !empty($product_data['type_id'])?$product_data['type_id']:'';
    $type_name    = !empty($product_data['type_name'])?$product_data['type_name']:'';
    $product_unit = !empty($product_data['product_unit'])?$product_data['product_unit']:'';
    $balance_qty  = !empty($product_data['balance_qty'])?$product_data['balance_qty']:'0';
?>
<style type="text/css">
    .form-actions
    {
