                                        ...
                                        <div class="col-sm-12 filter-design">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-2 text-right">
                                                    ...
                                                    <input type="hidden" name="func" id="func" class="func" value="list_employee">
                                            ...
                                            <div class="table_value hide">
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <th class="sorting" data-item="2" data-sort="1">User Name
                                                            <span class="hide up">&#8673;</span>
                                                            <span class="hide down">&#8675;</span>
                                                        </th>
                                                        <th class="sorting" data-item="3" data-sort="1">Contact No
                                                            <span class="hide up">&#8673;</span>
                                                            <span class="hide down">&#8675;</span>
                                                        </th>
                                                        <th class="sorting" data-item="4" data-sort="1">Log Type
                                                            <span class="hide up">&#8673;</span>
                                                            <span class="hide down">&#8675;</span>
                                                        </th>
