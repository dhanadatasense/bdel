            ...
            <section id="basic-form-layouts">
                <div class="row match-height">
                    <div class="col-md-12">
                        ...
                        $username    = !empty($value_1['name'])?$value_1['name']:'';
                        ...
                        echo '<option value="'.$employee_id.'" '.$select.'>'.$username.' ('.$mobile.')'.'</option>';
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <button type="button" class="btn btn-primary shop_list shop_submit m-t-27 <?php echo $hide_value; ?>" data-type="_s_c" data-value="managers" data-cntrl="assignshop" data-func="add_assign_shop">
                                ...
                                <?php
                                    if(!empty($zone_list))
                                    {
                                        foreach ($zone_list as $key => $value_3) {
                                            $zone_id   = !empty($value_3['id'])?$value_3['id']:'';
