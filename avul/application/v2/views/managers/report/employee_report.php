                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="sel_date" class="form-control sel_date dates" placeholder="Start Date" name="sel_date" value="" maxlength="0">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="func" id="func" class="func" value="employee_report">
                                                        <button type="button" class="btn btn-primary rpt_submit empDaily_report empDaily_submit m-t-27" data-type="_s_c" data-value="managers" data-cntrl="report" data-func="employee_report">
