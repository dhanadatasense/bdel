                                    ...
                                    <form class="data_form" name="data_form" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="func" id="func" class="func" value="outlet_overall">

                                                        <button type="button" class="btn btn-primary rpt_submit outletOverall_report outletOverall_submit" data-type="_s_c" data-value="managers" data-cntrl="report" data-func="outlet_overall">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 filter-design">
                                                <div class="outletOverall_value hide">
