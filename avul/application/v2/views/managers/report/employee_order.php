                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="func" id="func" class="func" value="employee_order">
                                                        <button type="button" class="btn btn-primary rpt_submit employee_report employee_submit m-t-27" data-type="_s_c" data-value="managers" data-cntrl="report" data-func="employee_order">
