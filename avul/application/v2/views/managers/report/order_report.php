                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="start_date" class="form-control start_date daterangepicker" placeholder="Start Date" name="start_date" value="" maxlength="0">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit order_report order_submit m-t-27" data-type="_s_c" data-value="managers" data-cntrl="report" data-func="order_report">
