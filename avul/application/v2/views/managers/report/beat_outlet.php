                                    ...
                                    <form class="data_form" name="data_form" method="post">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Beat Type<span class="text-danger">*</span></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit beatOutlet_report beatOutlet_submit" data-type="_s_c" data-value="managers" data-cntrl="report" data-func="beat_outlet">
