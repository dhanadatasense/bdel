                                    ...
                                    <form class="data_form" name="data_form" method="post">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Order By<span class="text-danger">*</span></label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group"> 
                                                        ...
                                                        <button type="button" class="btn btn-primary outletOrder_report outletOrder_submit m-t-27 " data-type="_s_c" data-value="managers" data-cntrl="report" data-func="outlet_order">
                                                            <span class="outletOrder_btn show"><i class="la la-check-square-o"></i> Submit</span>
                                                            <span class="outletOrder_span hide"><i class="la la-spinner spinner"></i> Loading....</span>
                                                        </button>

                                                        <!-- <button type="button" class="btn btn-primary outletOrder_report outletOrder_submit m-t-27 Loading hide" data-type="_s_c" data-value="managers" data-cntrl="report" data-func="outlet_order">
