                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="start_date" class="form-control start_date dates" placeholder="Start Date" name="start_date" value="" maxlength="0">
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="projectinput1">End Date <span class="text-danger">*</span></label>
                                                        <input type="text" id="end_date" class="form-control end_date dates" placeholder="End Date" name="end_date" value="" maxlength="0">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                ...
                                                <!-- <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            <label>Attendance Status <span class="text-danger">*</span></label><br>
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" id="postType1" name="pstatus" class="custom-control-input" <?php echo $p_att == 1 ? 'checked' : ''; ?> value="1">
                                                                <label class="custom-control-label" for="postType1">Present</label>
                                                            </div>
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" id="postType2" name="pstatus" class="custom-control-input" <?php echo $p_att == 0 ? 'checked' : ''; ?> value="0">
                                                                <label class="custom-control-label" for="postType2">Absent </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div> --> 
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="func" id="func" class="func" value="attendance_report">
                                                        <button type="button" class="btn btn-primary rpt_submit attendance_report attendance_submit m-t-27" data-type="_s_c" data-value="managers" data-cntrl="report" data-func="attendance_report">
