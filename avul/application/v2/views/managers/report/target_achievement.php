                                    ...
                                    <form class="data_form" name="data_form" method="post">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Year <span class="text-danger">*</span></label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary rpt_submit target_report target_submit m-t-27" data-type="_s_c" data-value="managers" data-cntrl="report" data-func="target_achievement">
