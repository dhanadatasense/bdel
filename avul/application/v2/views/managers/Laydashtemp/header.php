...
<html class="loading" lang="en" data-textdirection="ltr">
    <head>
        <title><?php echo $page_title; ?> - Hoisst Admin Panel</title>
        ...
        <link href="<?php echo BASE_URL; ?>app-assets/vendors/css/cryptocoins/cryptocoins.css" rel="stylesheet" type="text/css">

        <script src="<?php echo BASE_URL; ?>assets/css/jquery-ui.css"></script>

        <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL; ?>app-assets/css/select2.min.css">
