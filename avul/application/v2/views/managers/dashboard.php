<?php
   ...
   $access= $this->session->userdata('designation_code');
    $state_count       = !empty($data_value['state_count'])?$data_value['state_count']:'0';
    $out_let_c       = !empty($data_value['out_let_c'])?$data_value['out_let_c']:'0';
        ...
        <div class="app-content content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-body">
                    ...
                    <?php endif; ?>
                    <?php if($access== 'RSM'|| $access== 'ASM'|| $access== 'SO'):?>
                        <div class="col-xl-3 col-lg-6 col-12">
                            <div class="card pull-up">
                                <div class="card-content">
                                    <div class="card-body">
                            ...
                            <div class="card pull-up">
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="media d-flex">
                                            <div class="media-body text-left">
                                            <h3 class="primary"><?php echo $out_let_c; ?></h3>
                                                <h6>Outlets</h6>
                                            </div>
                                            <div>
                                                                ...
                                                                foreach ($order_data as $key => $val_3) {
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td class="border-top-0"><?php echo $order_view; ?></td>
                                                                            <td class="border-top-0"><a href="<?php echo BASE_URL; ?>index.php/managers/order/overall_order/view/<?php echo $random_value; ?>" class="button_clr btn btn-primary"><i class="ft-file-text"></i> </a></td>
                                                                        </tr>
                                                                    <?php
