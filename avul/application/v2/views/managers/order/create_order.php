                                    ...
                                    <form class="data_form" name="data_form" method="post">
                                                        ...
                                                        <table id="item_table" class="table">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="p-l-0">
                                                                        <button type="button" name="remove" class="btn btn-success btn-sm add_orders button_size m-t-6"><span class="ft-plus-square"></span></button>
                                                                    </th>
                                                                </tr>
                                                            </thead>
                                        ...
                                        <tr class="row_1">
                                            <td data-te="1" class="p-l-0 product_list" style="width: 30%;">
                                                <select data-te="1" name="product_id[]" id="product_id1" class="form-control product_id1 product_id product_val js-select1-multi" data-te="1" >
                                            ...
                                            <td class="p-l-0" style="width: 15%;">
                                                <input type="text" data-te="1" name="product_qty[]" id="product_qty1" class="form-control product_qty1 product_qty int_value" maxlength="5" oninput="this.value=this.value.replace(/^0+/g,'')" placeholder="Quantity">
