                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group" style="margin-top: 26px;">
                                                        ...
                                                        <input type="hidden" name="func" id="func" class="func" value="overall_outstanding">

                                                        <button type="button" class="btn btn-primary rpt_submit beatOutlet_report beatOutlet_submit" data-type="_s_c" data-value="distributors" data-cntrl="report" data-func="overall_outstanding">
