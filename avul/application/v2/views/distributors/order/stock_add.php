<?php
    ...
    $order_id      = !empty($order_value['order_id'])?$order_value['order_id']:'';
    $order_auto_id = !empty($order_value['order_auto_id'])?$order_value['order_auto_id']:'';
    $product_id    = !empty($order_value['product_id'])?$order_value['product_id']:'';
    $type_id       = !empty($order_value['type_id'])?$order_value['type_id']:'';
    $unit_val      = !empty($order_value['unit_val'])?$order_value['unit_val']:'';
    $description   = !empty($order_value['description'])?$order_value['description']:'';
    $bal_qty       = !empty($order_value['bal_qty'])?$order_value['bal_qty']:'';
?>
<style type="text/css">
    .form-actions
    {
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="received_qty" class="form-control received_qty" placeholder="<?php echo $bal_qty; ?>" name="received_qty" value="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card-content collapse show">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a data-id="<?php echo $stock_id; ?>" data-value="distributors" data-cntrl="order" data-func="order_stock" class="delete-btn button_clr btn btn-danger"><i class="ft-trash-2"></i> Delete </a></td>
                                    </tr>
                                <?php
                                                                $i++;
                                                                    }
