                                        ...
                                        <div class="col-sm-12 filter-design">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-2 text-right">
                                                    <select class="set_offset form-control getfilterval filteropt">
                                                ...
                                                <div class="col-sm-2 text-right">
                                                    ...
                                                    <input type="hidden" name="load_data" id="load_data" class="load_data" value="<?php echo $load_data; ?>">
                                                    ...
                                                    <input type="hidden" name="func" id="func" class="func" value="<?php echo $function_name; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 filter-design">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="statusModalLabel">Customer Review</h5>
