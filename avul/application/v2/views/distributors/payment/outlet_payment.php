        ...
        <div class="content-body">
            ...
            echo '<option value='.$pay_id.' '.$select.'>'.$bill_no.'</option>';
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="button" class="btn btn-primary outlet_payment" data-type="_s_c" data-value="distributors" data-cntrl="payment" data-func="outlet_payment" data-id="<?php echo $random_val; ?>" data-method="<?php echo $method; ?>" data-auto="<?php echo $auto_id; ?>">
