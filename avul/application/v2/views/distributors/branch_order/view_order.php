                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 m-t-10">
                                                            <div class="form-group text-right">
                                                                ...
                                                                <input type="hidden" name="cntrl" id="cntrl" class="cntrl" value="Branchorders">
                    ...
                    <div class="row">
                        <section class="card" style="width: 100%;">
                            <div id="invoice-template" class="card-body p-4">
                                                                ...
                                                                <tr class="row_<?php echo $i; ?>">
                                                                    ...
                                                                    <td class="font-12" style="width: 120px;"><span class="amount_<?php echo $auto_id; ?>"><?php echo number_format($net_total, 2); ?></span></td>
                                                                        ...
                                                                        <td class="font-12" style="width: 13%;">
                                                                                ...
                                                                                <a data-id="<?php echo $auto_id; ?>" class="order_update button_clr btn btn-primary" data-value="distributors" data-cntrl="Branchorders" data-func="order_process" style="background-color: #666ee8 !important;"><i class="ft-edit"></i></a>
                                                                            
                                                                           
                                                                                <a data-id="<?php echo $auto_id; ?>" data-progress="<?php echo $order_status; ?>" data-value="distributors" data-cntrl="Branchorders" data-func="order_process" class="delete-order button_clr btn btn-danger" style="background-color: #ff4961 !important;"><i class="ft-trash-2"></i></a>
                                                        ...
                                                        <tbody  id="myTable">
                                                            ...
                                                            foreach ($order_details as $key => $value) {
                                                                ...
                                                                if ($product_qty == $receive_qty) {
                                                                    ...
                                                                    $stk_link = BASE_URL . 'index.php/distributors/Branchorderss/order_stock/stock_add/' . $auto_id . '/' . $order_id;
                                                                }
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        ?>
                                                                            <button class="btn btn-warning pack_btn" data-id="<?php echo $auto_id; ?>" data-value="distributors" data-cntrl="Branchorders" data-func="order_process" data-method="_changePackStatus" style="padding: 4px;"><i class="ft-rotate-cw"></i> </button>

                                                                            <button class="btn btn-danger del_bth" data-id="<?php echo $auto_id; ?>" data-row="<?php echo $i; ?>" data-value="distributors" data-cntrl="Branchorders" data-func="order_process" data-method="_deletePackStatus" style="padding: 4px;"><i class="ft-trash-2"></i> </button>
                                ...
                                <?php
                                if ($order_status == 2) {
                                    $print_link = BASE_URL . 'index.php/distributors/Branchorders/print_order/' . $order_id;
                                ...
                                ?>
                                    <div id="invoice-footer">
                                        <div class="row">
                                            <div class="col-sm-12 col-12 text-right">
                                                <button class="btn btn-info btn-lg my-1 process_click" data-value="distributors" data-cntrl="Branchorders" data-func="order_process" data-method="_changePackProcess" data-id="<?php echo $order_id; ?>"><i class="fa fa-spinner"></i> Approved Order</button>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    if (!empty($dc_random)) {
                                        $print_link = BASE_URL . 'index.php/distributors/Branchorders/print_dc/' . $dc_random;

                                        $print_json = BASE_URL . 'index.php/distributors/Branchorders/print_json/' . $dc_random;
