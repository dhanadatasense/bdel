...
?>
<style type="text/css">
    .order_list .select2-container--default
    {
        width: 99% !important;
    }
</style>
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        echo '<option value="'.$month_value.'" '.$select.'>'.$month_name.'</option>';
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <button type="button" class="btn btn-primary invoice_list shop_submit m-t-27 <?php echo $hide_value; ?>" data-type="_s_c" data-value="distributors" data-cntrl="assignshop" data-func="add_assign_shop">
                ...
                ?>
                    <tr>
                        ...
                        <td data-te="<?php echo $i; ?>" class="p-l-0 order_list">
                            <select class="form-control order_id js-example-placeholder-multiple" id="zone_id" name="zone_id_<?php echo $i; ?>[]" multiple="multiple">';
                                <?php
                                    if(!empty($order_list))
                                    {
                                        foreach ($order_list as $key => $val_3) {
                                            ...
                                            $order_val = explode(',', $assign_invoice);

                                            $select = '';

                                            if(in_array($zone_id, $order_val))
                                            {
                                                $select = 'selected';
                                            }
