            ...
            <section id="basic-form-layouts">
                <div class="row match-height">
                    <div class="col-md-12">
                        ...
                        echo '<option value="'.$employee_id.'" '.$select.'>'.$username.' ('.$mobile.')'.'</option>';
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <button type="button" class="btn btn-primary shop_list shop_submit m-t-27 <?php echo $hide_value; ?>" data-type="_s_c" data-value="distributors" data-cntrl="assignshop" data-func="add_assign_beat">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" class="meeting_res" data-te="<?php echo $auto_id; ?>" id="meeting_status" name="meeting_status_<?php echo $auto_id; ?>" style="margin-top: 15px;" <?php echo ($meeting_val==1)?'checked':''; ?> >
                            <input type="hidden" name="meeting_val_<?php echo $auto_id; ?>" class="meeting_val_<?php echo $auto_id; ?>" value="<?php echo $meeting_val; ?>">
                        </td>
                        <!-- <td>
                ...
                <?php
                                        ...
                                        <div class="form-actions submit_btn <?php echo $view_value; ?>">
                                            ...
                                            <input type="hidden" name="func" id="func" class="func" value="add_assign_beat">
