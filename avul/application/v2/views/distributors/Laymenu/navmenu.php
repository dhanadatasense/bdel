                ...
                <div class="navbar-header">
                    <ul class="nav navbar-nav flex-row text-center">
                        ...
                        <li class="nav-item">
                            ...
                            <img class="brand-logo rounded mx-auto d-block center-block" alt="modern admin logo" style="margin-top: -20px;padding-left: 72px;" src="<?php echo BASE_URL; ?>app-assets/images/logob.jpg">
...
<!--                             <li class="dropdown dropdown-notification nav-item">
                            ...
                            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700"><?php echo $this->session->userdata('email'); ?></span><span class="avatar avatar-online"><img src="<?php echo BASE_URL; ?>app-assets/images/logo/logobdel.jpg" alt="avatar" style="background-color: #fff;"><i></i></span></a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="<?php echo BASE_URL;?>index.php/distributors/settings/profile_settings"><i class="ft-user"></i> Edit Profile</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="<?php echo BASE_URL;?>index.php/distributors/settings/change_password"><i class="icon-key"></i> Change Password</a>
                                    <div class="dropdown-divider"></div>
