<?php
	...
	$store_det       = !empty($return_data['store_details'])?$return_data['store_details']:'';
    ...
    $print_link = BASE_URL.'index.php/distributors/salesreturn/list_sales_return/print_invoice/'.$return_value;
?>
                        ...
                        <div id="invoice-customer-details" class="row pt-2">
                            ...
                            <div class="col-sm-6 col-12 text-center text-sm-right">
                                <ul class="px-0 list-unstyled">
                                    <li class="text-bold-800"><b><?php echo $store_name; ?></b></li>
                                    <li><?php echo $str_address; ?></li>
                                    <li><b>GSTIN:</b> <?php echo $str_gst_no; ?></li>
                                    <li><b>Contact No:</b> <?php echo $str_mobile; ?></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div id="invoice-footer">
                            <div class="row">
                                <div class="col-sm-12 col-12 text-right">
                                    <a href="<?php echo $print_link; ?>" class="btn btn-info btn-lg my-1"><i class="fa fa-print"></i> Print Order</a>
                                </div>
                            </div>
                        </div>
                    </div>
