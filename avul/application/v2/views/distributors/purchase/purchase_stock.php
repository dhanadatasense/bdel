...
<div class="app-content content">
    ...
    else
    {
        $stk_link = BASE_URL.'index.php/admin/purchase/purchase_stock/stock_add/'.$item_id.'/'.$purchase_id;
                                                            ...
                                                            ?>
    <tr>
        <td class="font-12" scope="row"><?php echo $i; ?></td>
        <td class="font-12"><p><?php echo $product_name; ?></p></td>
        <td class="font-12"><p><?php echo $category_name; ?></p></td>
        <td class="font-12"><?php echo $product_qty; ?> ( <?php echo $unit_name; ?> )</td>
        <td class="font-12"><?php echo $received_qty; ?> ( <?php echo $unit_name; ?> )</td>
        <td class="font-12"><a href="<?php echo $stk_link; ?>" class="button_clr btn btn-warning"><i class="ft-plus-square"></i> Add </a></td>
    </tr>
                                                            <?php
