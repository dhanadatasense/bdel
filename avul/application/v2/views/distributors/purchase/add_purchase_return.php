        ...
        <div class="content-body">
            <section id="basic-form-layouts">
                ...
                <tr class="row_1">
                    ...
                    <td class="p-l-0">
                        <input type="text" data-te="1" name="dis_product_qty[]" id="dis_product_qty1" class="form-control dis_product_qty1 dis_product_qty int_value" placeholder="Quantity">
                    ...
                    <td class="buttonlist p-l-0">
                        <button type="button" name="remove" class="btn btn-danger btn-sm  button_size m-t-6"><span class="ft-minus-square"></span></button>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <input type="hidden" name="func" id="func" class="func" value="add_purchase_return">
