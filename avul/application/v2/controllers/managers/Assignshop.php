	...
	class Assignshop extends CI_Controller {
		...
		{ 
			...
			if($formpage =='BTBM_X_P')
			{
			    ...
			    else
			    {
			    	...
			    	{
			    		// if(userAccess('assign-beat-edit'))
			    		// {
			...
			if($method =='getMonthData')
			{
			    ...
			    {	
					...
					$zone_list  = avul_call(API_URL.'managers/api/hierarchy_list',$where_3);
			...
			else
			{
            	...
            	$zone_data  = avul_call(API_URL.'managers/api/hierarchy_list',$where_3);
				...
				$page['pre_menu']     = "index.php/managers/assignshop/list_assign_shop";
				$data['page_temp']    = $this->load->view('managers/assign_shop/add_assign_shop',$page,TRUE);
		...
		public function list_assign_shop($param1="", $param2="", $param3="")
		{
			...
			if($param1 == '')
			{
				...
				//$page['page_access']  = userAccess('assign-beat-add');
				$page['pre_menu']     = "index.php/managers/assignshop/add_assign_shop";
				$data['page_temp']    = $this->load->view('managers/assign_shop/list_assign_shop',$page,TRUE);
				$data['view_file']    = "Page_Template";
			...
			{
				// if(userAccess('assign-beat-view'))
				// {
	            	...
	            	if(!empty($data_value))
	            	{
		            	...
		            	foreach ($data_value as $key => $value) {
			                ...
			                $edit   = '';
				            $delete = '';
				            // if(userAccess('assign-beat-edit') == TRUE)
				            // {
				            	$edit = '<a href="'.BASE_URL.'index.php/managers/assignshop/add_assign_shop/Edit/'.$assign_id.'" class="button_clr btn btn-primary"><i class="ft-edit"></i> Edit </a>';
				            // }
				            // if(userAccess('assign-beat-delete') == TRUE)
				            // {
				            	$delete = '<a data-row="'.$i.'" data-id="'.$assign_id.'" data-value="managers" data-cntrl="assignshop" data-func="list_assign_shop" class="delete-btn button_clr btn btn-danger"><i class="ft-trash-2"></i> Delete </a>';
				            // }
			                ...
			                $table .= '
						    	<tr class="row_'.$i.'">
	                               ...
	                               // if(userAccess('assign-beat-edit') == TRUE || userAccess('assign-beat-delete') == TRUE):
