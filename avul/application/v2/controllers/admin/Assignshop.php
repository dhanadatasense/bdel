	...
	class Assignshop extends CI_Controller {
		...
		public function add_assign_shop($param1="", $param2="", $param3="")
		{
			...
			else
			{
				...
				$page['pre_menu']     = "index.php/admin/assignshop/list_assign_shop";
				$data['page_temp']    = $this->load->view('admin/assign_shop/add_assign_shop',$page,TRUE);
		...
		public function list_assign_shop($param1="", $param2="", $param3="")
		{
			...
			if($param1 == '')
			{
				...
				$page['pre_menu']     = "index.php/admin/assignshop/add_assign_shop";
				$data['page_temp']    = $this->load->view('admin/assign_shop/list_assign_shop',$page,TRUE);
				$data['view_file']    = "Page_Template";
				...
				if(userAccess('assign-beat-view'))
				{
	            	...
	            	if(!empty($data_value))
	            	{
		            	...
		            	foreach ($data_value as $key => $value) {
				            ...
				            {
				            	$edit = '<a href="'.BASE_URL.'index.php/admin/assignshop/add_assign_shop/Edit/'.$assign_id.'" class="button_clr btn btn-primary"><i class="ft-edit"></i> Edit </a>';
				            }
				            if(userAccess('assign-beat-delete') == TRUE)
				            {
				            	$delete = '<a data-row="'.$i.'" data-id="'.$assign_id.'" data-value="admin" data-cntrl="assignshop" data-func="list_assign_shop" class="delete-btn button_clr btn btn-danger"><i class="ft-trash-2"></i> Delete </a>';
				            }
