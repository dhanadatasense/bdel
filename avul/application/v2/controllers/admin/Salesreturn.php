	...
	class Salesreturn extends CI_Controller {
		...
		public function add_sales_return($param1="", $param2="", $param3="")
		{
			...
			if($formpage =='BTBM_X_P')
			{
			    ...
			    else
			    {
			    	if($method == 'BTBM_X_C')
			    	{
			    		if(userAccess('sales-return-add'))
			    		{
			    			$return_type  = [];
			...
			else
			{
				...
				$page['pre_menu']        = "index.php/admin/salesreturn/list_sales_return";
				$data['page_temp']       = $this->load->view('admin/salesreturn/add_sales_return',$page,TRUE);
		...
		{	
			...
			if($param1 == '')
			{
				...
				$page['pre_menu']     = "index.php/admin/salesreturn/add_sales_return";
				$page['page_access']     = userAccess('sales-return-add');
				$data['page_temp']    = $this->load->view('admin/salesreturn/list_sales_return',$page, TRUE);
				$data['view_file']    = "Page_Template";
			...
			{
				if(userAccess('sales-return-view'))
				{	
		            	...
		            	foreach ($data_value as $key => $value) {
						    ...
						    $table .= '
						    	<tr>
	                                ...
	                                <td>
	                                	<a href="'.BASE_URL.'index.php/admin/salesreturn/list_sales_return/View/'.$random_value.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i> View </a>
	                                </td>
	                            </tr>
						    ';
						    $i++;
			...
			else if($param1 == 'View')
			{
				...
				$page['page_access']   = userAccess('sales-return-view');
				$page['pre_menu']      = "index.php/admin/salesreturn/list_sales_return";
				$data['page_temp']     = $this->load->view('admin/salesreturn/view_sales_return',$page,TRUE);
				$data['view_file']     = "Page_Template";
				$data['currentmenu']   = "list_sales_return";
				$this->bassthaya->load_admin_form_template($data);
