	...
	class Assignproduct extends CI_Controller {
		...
		public function add_assign_product($param1="", $param2="", $param3="")
		{
            ...
            if($param1 =='getZone_name')
			{
				...
				if(!empty($city_id))
				{
					...
					$where = array(
						...
						'type_id'  => $type_id,
						'ref_id'   =>  $this->session->userdata('id'),
	            		'method'    => '_detailAssignProductZone',
	            	);
					
					
					
	          	    $zone_list   = avul_call(API_URL.'assignproduct/api/list_assign_product',$where);
			...
			//	$page['page_access']  = userAccess('assign-product-view');
				$page['pre_menu']     = "index.php/distributors/assignproduct/list_assign_product";
				$data['page_temp']    = $this->load->view('distributors/assign_product/add_assign_product',$page,TRUE);
		...
		public function list_assign_product($param1="", $param2="", $param3="")
		{
	            	...
	            	if(!empty($data_value))
	            	{
		            	...
		            	foreach ($data_value as $key => $value) {
				            ...
				            $delete = '';
				            	...
				            	$edit = '<a href="'.BASE_URL.'index.php/distributors/assignproduct/add_assign_product/Edit/'.$assign_id.'" class="button_clr btn btn-primary"><i class="ft-edit"></i> Edit </a>';
				          
				            	$delete = '<a data-row="'.$i.'" data-id="'.$assign_id.'" data-value="distributors" data-cntrl="assignproduct" data-func="list_assign_product" class="delete-btn button_clr btn btn-danger"><i class="ft-trash-2"></i> Delete </a>';
			...
			else
        	{
				...
				$data['page_temp']    = $this->load->view('distributors/assign_product/list_assign_product',$page,TRUE);
				$data['view_file']    = "Page_Template";
				$data['currentmenu']  = "distributor_list";
				$this->bassthaya->load_distributors_form_template($data);
			}
		...
		public function distributor_list($param1="", $param2="", $param3="")
		{
			...
			if($param1 == '')
			{
				...
				$data['page_temp']    = $this->load->view('distributors/assign_product/list_distributors',$page,TRUE);
				$data['view_file']    = "Page_Template";
				$data['currentmenu']  = "distributor_list";
				$this->bassthaya->load_distributors_form_template($data);
			}
	            	...
	            	if(!empty($data_list))
	            	{
		            	...
		            	foreach ($data_value as $key => $value) {
			                ...
			                $list_2   = '';
				            	...
				            	$list_1 = '<a href="'.BASE_URL.'index.php/distributors/assignproduct/list_assign_product/'.$distributor_id.'" class="button_clr btn btn-primary"><i class="ft-edit"></i> Assign Beat </a>';

				            	$list_2 = '<a href="'.BASE_URL.'index.php/distributors/assignproduct/assign_multi_beat/'.$distributor_id.'" class="button_clr btn btn-success"><i class="ft-edit"></i> Multi Beat </a>';
		...
		public function assign_multi_beat($param1="", $param2="", $param3="")
		{
        	...
        	if($formpage =='BTBM_X_P')
        	{
                ...
                //type_id = db-> assign product_details ->id
		    	$data = array(
		    		'distributor_id' => $distributor_id,
		    		'state_id'       => $state_id,
		    		'city_id'        => $city_val,
					...
					'type_id'        => $product_val,
					'ref_id'         => $this->session->userdata('id'),
					'method'         => '_assignMultipleBeat_dis',
				);
            ...
            if($param1 =='getZone_name')
        	{
				...
				if(!empty($city_id))
				{
					...
					$zone_list   = avul_call(API_URL.'assignproduct/api/assign_multiple_beat',$whereeee);
                
                    $zone_result =[];
					$zone_result = $zone_list;
					
	        		if(!empty($zone_list['data']))
	        		{
	        			foreach ($zone_list['data'] as $key => $value) {
        	...
        	else
        	{
				...
				$page['pre_title']       = "Add Distributors";
				$page['pre_menu']        = "index.php/distributors/distributor/add_distributors";
				$data['page_temp']    = $this->load->view('distributors/assign_product/assign_multi_beat',$page,TRUE);
				$data['view_file']    = "Page_Template";
				$data['currentmenu']  = "distributor_list";
				$this->bassthaya->load_distributors_form_template($data);
        	}
