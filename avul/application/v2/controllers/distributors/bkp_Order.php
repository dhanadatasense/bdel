	...
	class Order extends CI_Controller {
            		...
            		foreach ($data_value as $key => $value) {
		                ...
		                $table .= '
					    	<tr>
		                        ...
		                        <td>'.$order_view.'</td>
		                        <td><a href="'.BASE_URL.'index.php/distributors/order/overall_order/view/'.$random_value.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i> View </a></td>
                            </tr>
					    ';
            		...
            		foreach ($data_value as $key => $value) {
		                ...
		                $table .= '
					    	<tr>
                                ...
                                <td>'.mb_strimwidth($store_name, 0, 25, '...').'</td>
		                        <td>'.$order_view.'</td>
		                        <td><a href="'.BASE_URL.'index.php/distributors/order/process_order/view/'.$random_value.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i> View </a></td>
                            </tr>
					    ';
            		...
            		foreach ($data_value as $key => $value) {
		                ...
		                $table .= '
					    	<tr>
                                ...
                                <td>'.mb_strimwidth($store_name, 0, 25, '...').'</td>
		                        <td>'.$order_view.'</td>
		                        <td><a href="'.BASE_URL.'index.php/distributors/order/packing_order/view/'.$random_value.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i> View </a></td>
                            </tr>
					    ';
            		...
            		foreach ($data_value as $key => $value) {
		                ...
		                $table .= '
					    	<tr>
                                ...
                                <td>'.mb_strimwidth($store_name, 0, 25, '...').'</td>
		                        <td>'.$order_view.'</td>
		                        <td><a href="'.BASE_URL.'index.php/distributors/order/ready_to_shipping_order/view/'.$random_value.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i> View </a></td>
                            </tr>
					    ';
            		...
            		foreach ($data_value as $key => $value) {
		                ...
		                $table .= '
					    	<tr>
                                ...
                                <td>'.mb_strimwidth($store_name, 0, 25, '...').'</td>
		                        <td>'.$order_view.'</td>
		                        <td><a href="'.BASE_URL.'index.php/distributors/order/invoice_order/view/'.$random_value.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i> View </a></td>
                            </tr>
					    ';
            		...
            		foreach ($data_value as $key => $value) {
		                ...
		                $table .= '
					    	<tr>
                                ...
                                <td>'.mb_strimwidth($store_name, 0, 25, '...').'</td>
		                        <td>'.$order_view.'</td>
		                        <td><a href="'.BASE_URL.'index.php/distributors/order/shipping_order/view/'.$random_value.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i> View </a></td>
                            </tr>
					    ';
    	...
    	public function delivery_order($param1="", $param2="", $param3="")
		{
            		...
            		foreach ($data_value as $key => $value) {
		                ...
		                $table .= '
					    	<tr>
                                ...
                                <td>'.mb_strimwidth($store_name, 0, 25, '...').'</td>
		                        <td>'.$order_view.'</td>
		                        <td><a href="'.BASE_URL.'index.php/distributors/order/delivery_order/view/'.$random_value.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i> View </a></td>
                            </tr>
					    ';
			...
			else if($param1 == 'view')
			{
				...
				$page['page_title']    = "Delivered Order";
				$page['pre_title']     = "";
				$page['pre_menu']      = "index.php/distributors/order/delivery_order";
				$data['page_temp']     = $this->load->view('distributors/order/view_order',$page,TRUE);
				$data['view_file']     = "Page_Template";
				$data['currentmenu']   = "delivery_order";
				$this->bassthaya->load_distributors_form_template($data);
            		...
            		foreach ($data_value as $key => $value) {
		                ...
		                $table .= '
					    	<tr>
                                ...
                                <td>'.mb_strimwidth($store_name, 0, 25, '...').'</td>
		                        <td>'.$order_view.'</td>
		                        <td><a href="'.BASE_URL.'index.php/distributors/order/cancel_order/view/'.$random_value.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i> View </a></td>
                            </tr>
					    ';
