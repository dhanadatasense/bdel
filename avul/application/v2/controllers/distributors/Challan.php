<?php
	...
	class Challan extends CI_Controller {
		...
		public function add_challan($param1="", $param2="", $param3="")
		{
			    ...
			    else
			    {
			    	if($method == 'BTBM_X_C')
			    	{
			    		...
			    		$data = array(
					    	...
					    	'method'           => '_add_dis_Purchase',
					    );
                 
					    $data_save = avul_call(API_URL.'distributorpurchase/api/add_distributor_order',$data);
			...
			else
			{
				...
				$page['page_title']  = "Add Delivary Challan";
				$page['main_heading'] = "Delivary Challan";
				$page['sub_heading']  = "Delivary Challan";
				$page['pre_title']    = "List Delivary Challan";
				$page['pre_menu']     = "index.php/distributors/challan/list_challan";
				$data['page_temp']    = $this->load->view('distributors/delivery/add_challan',$page,TRUE);
				$data['view_file']    = "Page_Template";
				$data['currentmenu']  = "add_challan";
				$this->bassthaya->load_distributors_form_template($data);
			}
		}

		public function list_challan($param1="", $param2="", $param3="")
		{
			if ($this->session->userdata('random_value') == '')
        	redirect(base_url() . 'index.php?login', 'refresh');
			...
			if($param1 == '')
			{
				$page['main_heading'] = "Delivary Challan";
				$page['sub_heading']  = "Delivary Challan";
				$page['page_title']   = "List Delivary Challan";
				$page['pre_title']    = "Add Delivary Challan";
				$page['pre_menu']     = "index.php/distributors/challan/add_challan";
				$data['page_temp']    = $this->load->view('distributors/delivery/view_challans',$page,TRUE);
				$data['view_file']    = "Page_Template";
				$data['currentmenu']  = "list_challan";
				$this->bassthaya->load_distributors_form_template($data);
			}
	            	...
	            	foreach ($data_value as $key => $value) {
					    ...
					    $table .= '
					    	<tr>
                                ...
                                <td>
                                	<a href="'.BASE_URL.'index.php/distributors/challan/view_orders/View/'.$order_id.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i> View </a>
                                </td>
                            </tr>
					    ';
					    $i++;
		...
		public function view_orders($param1="", $param2="", $param3="")
		{
			if ($this->session->userdata('random_value') == '')
        	redirect(base_url() . 'index.php?login', 'refresh');
			...
			if($param1 =='View')
			{
				...
				$page['pre_menu']      = "index.php/distributors/Delivary/view_challans";
				$data['page_temp']     = $this->load->view('distributors/delivery/view_orders',$page,TRUE);
				$data['view_file']     = "Page_Template";
				$data['currentmenu']   = "list_challan";
				$this->bassthaya->load_distributors_form_template($data);
			}
...
// 					    $data_save = avul_call(API_URL.'distributorpurchase/api/add_distributor_dc',$data);
