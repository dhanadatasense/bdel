...
<?php
	...
	class Branchorders extends CI_Controller {
		...
		public function br_overall_order($param1="", $param2="", $param3="")
		{
			...
			if($param1 == '')
			{
				$page['main_heading']  = "Branch Order";
				$page['sub_heading']   = "Branch Order";
				$page['page_title']    = "Overall Order";
				$page['load_data']     = "";
				$page['function_name'] = "br_overall_order";
				$data['page_temp']     = $this->load->view('distributors/branch_order/list_order',$page,TRUE);
				$data['view_file']     = "Page_Template";
				$data['currentmenu']   = "br_overall_order_dc";
	            	...
	            	if(!empty($data_value))
	            	{
		            	...
		            	foreach ($data_value as $key => $value) {
						    ...
						    if($order_status == '1')
						    {
						        ...
						        $order_btn  = '<a class="button_clr btn btn-warning process_bth" data-value="distributors" data-cntrl="Branchorders" data-func="order_process" data-id="'.$order_id.'" data-method="changeOrder_status"><i class="ft-edit"></i></a>';
						    }
				            ...
				            {
				            	$view = '<a href="'.BASE_URL.'index.php/distributors/Branchorders/br_overall_order/View/'.$order_id.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i></a>';
				            }
			...
			else if($param1 == 'View')
			{
				...
				$data['page_temp']     = $this->load->view('distributors/branch_order/view_order',$page,TRUE);
				$data['view_file']     = "Page_Template";
				$data['currentmenu']   = "br_overall_order_dc";
				$this->bassthaya->load_distributors_form_template($data);
			}
		...
		public function br_success_order($param1="", $param2="", $param3="")
		{
			...
			if($param1 == '')
			{
				...
				$data['page_temp']     = $this->load->view('distributors/branch_order/list_order',$page,TRUE);
				$data['view_file']     = "Page_Template";
				$data['currentmenu']   = "br_success_order_dc";
				$this->bassthaya->load_distributors_form_template($data);
			}
	            	...
	            	if(!empty($data_value))
	            	{
		            	...
		            	foreach ($data_value as $key => $value) {
				            ...
				            $view = '';
				            	...
				            	$view = '<a href="'.BASE_URL.'index.php/distributors/Branchorders/br_success_order/View/'.$order_id.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i></a>';
		...
		public function br_process_order($param1="", $param2="", $param3="")
		{
			...
			if($param1 == '')
			{
				...
				$data['page_temp']     = $this->load->view('distributors/branch_order/list_order',$page,TRUE);
				$data['view_file']     = "Page_Template";
				$data['currentmenu']   = "br_process_order_dc";
				$this->bassthaya->load_distributors_form_template($data);
			}
				...
				// {
	            	...
	            	if(!empty($data_value))
	            	{
		            	...
		            	foreach ($data_value as $key => $value) {
				            ...
				            // {
				             	$view = '<a href="'.BASE_URL.'index.php/distributors/Branchorders/br_process_order/View/'.$order_id.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i></a>';
				           // }
		...
		public function br_packing_order($param1="", $param2="", $param3="")
		{
			...
			if($param1 == '')
			{
				...
				$data['page_temp']     = $this->load->view('distributors/branch_order/list_order',$page,TRUE);
				$data['view_file']     = "Page_Template";
				$data['currentmenu']   = "br_packing_order_dc";
				$this->bassthaya->load_distributors_form_template($data);
			}
	            	...
	            	if(!empty($data_value))
	            	{
		            	...
		            	foreach ($data_value as $key => $value) {
				          ...
				          //  {
				            ...
				            // if(userAccess('delivery-challan-view') == TRUE)
				            // {
				            	$view = '<a href="'.BASE_URL.'index.php/distributors/Branchorders/br_packing_order/View/'.$order_id.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i></a>';
				            //}
		...
		public function br_shipping_order($param1="", $param2="", $param3="")
		{
			...
			if($param1 == '')
			{
				...
				$data['page_temp']     = $this->load->view('distributors/branch_order/list_order',$page,TRUE);
				$data['view_file']     = "Page_Template";
				$data['currentmenu']   = "br_shipping_order_dc";
				$this->bassthaya->load_distributors_form_template($data);
			}
				...
				//{
	            	...
	            	if(!empty($data_value))
	            	{
		            	...
		            	foreach ($data_value as $key => $value) {
				            ...
				            // if(userAccess('delivery-challan-view') == TRUE)
				            // {
				            	$view = '<a href="'.BASE_URL.'index.php/distributors/Branchorders/br_shipping_order/View/'.$order_id.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i></a>';
				            // }
		...
		public function br_delivery_order($param1="", $param2="", $param3="")
		{
			...
			if($param1 == '')
			{
				...
				$data['page_temp']     = $this->load->view('distributors/branch_order/list_order',$page,TRUE);
				$data['view_file']     = "Page_Template";
				$data['currentmenu']   = "br_delivery_order_dc";
				$this->bassthaya->load_distributors_form_template($data);
			}
	            	...
	            	if(!empty($data_value))
	            	{
		            	...
		            	foreach ($data_value as $key => $value) {
				            ...
				            $view = '';
				            	...
				            	$view = '<a href="'.BASE_URL.'index.php/distributors/Branchorders/br_delivery_order/View/'.$order_id.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i></a>';
		...
		public function br_complete_order($param1="", $param2="", $param3="")
		{
			...
			if($param1 == '')
			{
				...
				$data['page_temp']     = $this->load->view('distributors/branch_order/list_order',$page,TRUE);
				$data['view_file']     = "Page_Template";
				$data['currentmenu']   = "br_complete_order_dc";
				$this->bassthaya->load_distributors_form_template($data);
			}
	            	...
	            	if(!empty($data_value))
	            	{
		            	...
		            	foreach ($data_value as $key => $value) {
				            ...
				            $view = '';
				            	...
				            	$view = '<a href="'.BASE_URL.'index.php/distributors/Branchorders/br_complete_order/View/'.$order_id.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i></a>';
		...
		public function br_cancle_order($param1="", $param2="", $param3="")
		{
			...
			if($param1 == '')
			{
				...
				$data['page_temp']     = $this->load->view('distributors/branch_order/list_order',$page,TRUE);
				$data['view_file']     = "Page_Template";
				$data['currentmenu']   = "br_cancle_order_dc";
				$this->bassthaya->load_distributors_form_template($data);
			}
	            	...
	            	if(!empty($data_value))
	            	{
		            	...
		            	foreach ($data_value as $key => $value) {
				            ...
				            $view = '';
				            	...
				            	$view = '<a href="'.BASE_URL.'index.php/distributors/Branchorders/br_cancle_order/View/'.$order_id.'" class="button_clr btn btn-primary"><i class="ft-file-text"></i></a>';
		...
		public function order_stock($param1="", $param2="", $param3="")
    	{
			...
			if($param1 =='stock_add')
			{
				...
				$page['pre_menu']      = "index.php/admin/distributorsorder/br_packing_order/View/$order_id";
		...
		public function print_order($param1="", $param2="", $param3="")
		{
	    	...
	    	if($data_value)
	    	{
	            ...
	            // Admin Details ==  distributor detais
	            ...
	            // Distributor Details   == sub distributors details
				...
				$pdf->SetTitle('Manufacturer Order');
			    ...
			    $html .='<br><br>
				  <table border= "1" cellpadding="1" top="100">
					  <tr>
						  ...
						  <td style="font-size:12px; width: 48%;">Description</td>
						  <td style="font-size:12px; text-align: center; width: 10%;">HSN</td>
						  <td style="font-size:12px; text-align: center; width: 10%;">Qty</td>
						  <td style="font-size:12px; text-align: center; width: 10%;">Per</td>
						  <td style="font-size:12px; text-align: center; width: 17%;">Amount</td>
					  </tr>';
					  ...
					  foreach ($ord_det as $key => $val) {
						  ...
						  $html .= '
							  <tr>
								  ...
								  <td style="font-size:12px; text-align: center; width: 10%;">'.$order_qty.'</td>
								  <td style="font-size:12px; text-align: center; width: 10%;">nos</td>
								  <td style="font-size:12px; text-align: center; width: 17%;">'.number_format((float)$tot_price, 2, '.', '').'</td>
							  </tr>
						  ';
			    ...
			    $html .= '
				  <tr>
					  ...
					  <td colspan="3" style="font-size:12px; text-align: right;" class="text-right">Qty</td>
					  <td style="font-size:12px; text-align: right;"> '.$tot_qty.'</td>
					  
				  </tr>
				  <tr>
					  <td colspan="3" style="font-size:12px; text-align: right;">Sub Total</td>
					  <td style="font-size:12px; text-align: right;"> '.number_format((float)$sub_tot, 2, '.', '').'</td>
				  </tr>';
				

				    $html .='<tr>
					  <td colspan="3" style="font-size:12px; text-align: right;">Round off</td>
