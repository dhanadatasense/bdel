<?php
    ...
    // Write sheet
    function write_to_sheet($spreadsheetId = '', $sheet_range = '', $table_values = array()) {
    ...
    $db  = new DB();
    $tbl = $db->get_distributor_list($create);

    $spreadsheetId = !empty($tbl['spreadsheetId'])?$tbl['spreadsheetId']:'';
    $sheet_range   = $tbl['sheet_range'];
    $table_values  = $tbl['sheet_data'];

    $write = write_to_sheet($spreadsheetId, $sheet_range, $table_values);
